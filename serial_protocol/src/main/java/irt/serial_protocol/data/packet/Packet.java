...
public class Packet {
	...
	/* Measurement codes. */
	public static final byte
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_NONE = IRT_SLCP_PARAMETER_NONE,
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_SUMMARY_ALARM	= 1,	//Flags
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_STATUS			= 2,
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_TEMPERATURE		= 3,
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_INPUT_POWER		= 4,
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_OUTPUT_POWER		= 5,
		...
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_CURRENT			= 9,
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_TEMPERATURE_CPU	= 10,
		IRT_SLCP_PARAMETER_MEASUREMENT_FCM_ALL = IRT_SLCP_PARAMETER_ALL;	/* Read all available measurements. */
	...
	/* Configuration codes. */
	public static final byte
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_NONE = (IRT_SLCP_PARAMETER_NONE),
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_GAIN				= 1,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_ATTENUATION		= 2,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_FREQUENCY			= 3,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_FREQUENCY_RANGE	= 4,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_GAIN_RANGE			= 5,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_ATTENUATION_RANGE	= 6,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_MUTE_CONTROL		= 7,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_BUC_ENABLE			= 8,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_FLAGS 				= 9,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_GAIN_OFFSET		= 10,
		IRT_SLCP_PARAMETER_CONFIGURATION_FCM_ALL = IRT_SLCP_PARAMETER_ALL;		/* Read all available parameters. */
	...
	public static final byte
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_NONE 					= IRT_SLCP_PARAMETER_NONE,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_LO_SET 				= 1,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_MUTE_CONTROL			= 2,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_GAIN 					= 3,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_ATTENUATION 			= 4,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_GAIN_RANGE 			= 5,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_ATTENUATION_RANGE		= IRT_SLCP_PARAMETER_CONFIGURATION_FCM_ATTENUATION_RANGE,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_LO_FREQUENCIES			= 7,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_USER_FREQUENCY 		= 8,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_USER_FREQUENCY_RANGE 	= 9,
							IRT_SLCP_PARAMETER_CONFIGURATION_PICOBUC_ALL 					= IRT_SLCP_PARAMETER_ALL;
	...
	public Packet(PacketHeader packetHeader, Payload payload) {
	...
	public static Packet creatPacket(int optype) {
		...
		case OPTYPE_CONFIG_GET_MUTE:
			packet.set(new byte[]{	IRT_SLCP_PACKET_TYPE_REQUEST,
											...
											IRT_SLCP_PACKET_TYPE_SPONTANEOUS,
											IRT_SLCP_PARAMETER_CONFIGURATION_FCM_MUTE_CONTROL,0,0});
			break;
		...
		case OPTYPE_CONFIG_GET_FREQUENCY:
			packet.set(new byte[]{	IRT_SLCP_PACKET_TYPE_REQUEST,
											IRT_SLCP_PACKET_ID_CONFIGURATION,
											IRT_SLCP_PACKET_TYPE_SPONTANEOUS,
											IRT_SLCP_PARAMETER_CONFIGURATION_FCM_FREQUENCY,0,0});
			break;
		...
		case OPTYPE_CONFIG_GET_ATTENUATION:
			packet.set(new byte[]{	IRT_SLCP_PACKET_TYPE_REQUEST,
											IRT_SLCP_PACKET_ID_CONFIGURATION,
											IRT_SLCP_PACKET_TYPE_SPONTANEOUS,
											IRT_SLCP_PARAMETER_CONFIGURATION_FCM_ATTENUATION,0,0});
			break;
		case OPTYPE_CONFIG_GET_ATTEN_RANGE:
			packet.set(new byte[]{	IRT_SLCP_PACKET_TYPE_REQUEST,
											IRT_SLCP_PACKET_ID_CONFIGURATION,
											IRT_SLCP_PACKET_TYPE_SPONTANEOUS,
											IRT_SLCP_PARAMETER_CONFIGURATION_FCM_ATTENUATION_RANGE,0,0});
			break;
		...
		case OPTYPE_CONFIG_GAIN_RANGE:
			packet.set(new byte[]{	IRT_SLCP_PACKET_TYPE_REQUEST,
											IRT_SLCP_PACKET_ID_CONFIGURATION,
											IRT_SLCP_PACKET_TYPE_SPONTANEOUS,
											IRT_SLCP_PARAMETER_CONFIGURATION_FCM_GAIN_RANGE ,0,0});
			break;
