...
public class PacketHeader{
	...
	public PacketHeader(Type type, Group group, short packetId) {
		this();
	...
	public String getPacketIdStr() {
		...
		if (packetHeader != null) {
			...
			case PacketWork.PACKET_DEVICE_INFO:
				...
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_GAIN:
				packetIdStr = "Gain("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_GAIN_RANGE:
				packetIdStr = "GainRange("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_ATTENUATION:
				packetIdStr = "Attenuation("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_ATTENUATION_RANGE:
			...
			case PacketWork.PACKET_BIAS_25W_DEVICE_DEBAG_CONVERTER_PLL_2:
				...
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_FREQUENCY:
				packetIdStr = "Frequency("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_FREQUENCY_RANGE:
				packetIdStr = "FrequencyRange("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_LO_BIAS_BOARD:
				packetIdStr = "LO Bais Board("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_LO_FREQUENCIES:
				packetIdStr = "LO Frequencies("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_GAIN_OFFSET:
				packetIdStr = "Gain Offset("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_LNB:
				packetIdStr = "LNB On/Off("+packetId+")";
				break;
			case PacketWork.PACKET_ID_CONFIGURATION_FCM_STORE_CONFIG:
